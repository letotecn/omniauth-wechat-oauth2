...
module OmniAuth
  module Strategies
    class Wechat < OmniAuth::Strategies::OAuth2
      ...
      def request_phase
        params = client.auth_code.authorize_params.merge(redirect_uri: callback_url.gsub('wechat-staging2.letote.cn','wechat-staging.letote.cn')).merge(authorize_params)
